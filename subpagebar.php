<div class="desktopNav">
    ...
    <div class="subPageBarContain">
        <div class="infobar row subPageBar">
            ...
            <div class="homeIcon"><a href="<?php home_url(); ?>"><img src="<?php echo get_template_directory_uri(); ?>/img/bf-icon-white.svg"></a></div>
            ...
            <div class="smallMenu">
                <div class="smallHome"><a href="<?php home_url(); ?>"><img src="<?php echo get_template_directory_uri(); ?>/img/home.jpg"></a></div>
                <div class="smallPhone"><img class="" src="<?php echo get_template_directory_uri(); ?>/img/phone.jpg"></div>
                <div class="smallEmail"><a href="<?php home_url("/contact"); ?>"><img class="" src="<?php echo get_template_directory_uri(); ?>/img/email.jpg"></a></div>
